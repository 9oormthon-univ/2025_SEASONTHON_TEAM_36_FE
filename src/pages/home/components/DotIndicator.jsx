...
/**
 * DotIndicator
 * - index, total, maxDots: 기본 동작 동일
 * - dot: 기본 점 지름(px)  (기본 10)
 * - activeScale: 활성 점 배율 (기본 1.35)
 * - edgeScale: 창 가장자리(비활성) 점 배율 (기본 0.8)
 * - gap: 점 간격(px) (기본 8)
 */
  ...
  return (
    ...
    >
      {Array.from({ length: visible }).map((_, i) => {
        ...
        else if (i === 0 && hasLeftHidden) scale = edgeScale;                 // 왼쪽 끝 축소
